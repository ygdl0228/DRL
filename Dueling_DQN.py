# @Time    : 2023/4/23 10:04
# @Author  : ygd
# @FileName: Dueling_DQN.py
# @Software: PyCharm
...
class Dueling_VAnet(torch.nn.Module):
    ''' 只有一层隐藏层的Q网络 '''

    def __init__(self, state_dim, hidden_dim, action_dim):
        super(Dueling_VAnet, self).__init__()
...
class Dueling_DQN:
    ...
    def __init__(self, state_dim, hidden_dim, action_dim, learning_rate, gamma,
        ...
        self.q_net = Dueling_VAnet(state_dim, hidden_dim,
                           self.action_dim).to(device)  # Q网络
        # 目标网络
        self.target_q_net = Dueling_VAnet(state_dim, hidden_dim,
...
if __name__ == '__main__':
    ...
    env.seed(0)
    torch.manual_seed(0)
    replay_buffer = Dueling_ReplayBuffer(buffer_size)
